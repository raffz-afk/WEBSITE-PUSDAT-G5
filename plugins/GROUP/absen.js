/**
 * ============================================================
 *  MODIFIKASI: plugins/GROUP/absen.js
 *  Ubah command 'absen' → 'absensi' (agar tidak konflik)
 * ============================================================
 *
 *  PERUBAHAN:
 *  HANYA baris Commands di export yang berubah.
 *  Command 'absen' diubah menjadi 'absensi'.
 *  Seluruh logika tetap 100% sama.
 *
 *  INSTRUKSI: Ganti file plugins/GROUP/absen.js dengan file ini.
 *
 * ============================================================
 */
...
export default {
  handle,
  // ★ PERUBAHAN: 'absen' → 'absensi' agar tidak konflik dengan Pusdat
  Commands: ["absensi"],
  OnlyPremium: false,
  OnlyOwner: false,
};
